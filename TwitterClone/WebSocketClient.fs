...
let WebSocketTest (endpoint : WebSocketEndpoint<Server.S2CMessage, Server.C2SMessage>) =
    ...
    let addTweetInUi (by,tweet,time) =
        ...
        tweetContentDiv.InnerHTML <- String.Format("<div style=\"display:flex;justify-content:center\"><div>{0}</div><div style=\"margin-left:10px\">{1}</div><div style=\"margin-left:10px\">{2}</div><div>",tweet,time,by)
    ...
    let subscribeForm = 
        div [] [
                ...
                button [ 
                    attr.``class`` "btn btn-primary"
                    on.click (enableOnClick "Subscribe") ] [ text "Subscribe" ]
            ]
    ...
    let unsubscribeForm  = 
        div [] [
                ...
                button [ 
                    attr.``class`` "btn btn-primary"
                    on.click (enableOnClick "Unsubscribe") ] [ text "Unsubscribe" ]
            ]
    // create Tweet  form.
    let createTweetForm = 
        div [] [
                ...
                button [ 
                    attr.``class`` "btn btn-primary"
                    on.click (enableOnClick "Tweet" ) ] [ text "Tweet" ]
            ]
    ...
    let hashTagForm = 
        div [] [
                ...
                button [ 
                    attr.``class`` "btn btn-primary"
                    on.click (enableOnClick "HashTag" ) ] [ text "HashTag search" ]
            ]
    // Mention form.
    let mentionForm = 
        div [] [
                ...
                button [ 
                    attr.``class`` "btn btn-primary"
                    on.click (enableOnClick "Mention") ] [ text "Mention search" ]
            ]
